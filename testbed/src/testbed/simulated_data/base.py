...
class SimulatedDataset:
    ...
    def sample(self, n: int, seed: int) -> Tuple[Float[ndarray, "n x_dim"], Float[ndarray, "n y_dim"]]:
        """
        Sample n data points from the dataset.
        """
        raise NotImplementedError

    def score(self, x: Float[ndarray, "batch x_dim"], y: Float[ndarray, "samples batch y_dim"]) -> Float[ndarray, "n"]:
        """
